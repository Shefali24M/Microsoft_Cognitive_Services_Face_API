...
for i in range(0, 2):
    ...
    cv2.waitKey(100)
    cv2.imshow("Face",img)
    image_path = "C:/Users/SHEFALI MANGAL/Documents/GitHub/Microsoft_Cognitive_Services_Face_API/capturePerson/image.jpg"
...
#        print(value_max)
    ...
    os.remove("C:/Users/SHEFALI MANGAL/Documents/GitHub/Microsoft_Cognitive_Services_Face_API/capturePerson/image.jpg")
    i=i+1
    time.sleep(4)
cam.release()
